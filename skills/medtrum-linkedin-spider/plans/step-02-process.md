...
python3 /app/runtime/skills-user/medtrum-linkedin-spider/scripts/extract_for_judgment.py "$OD/linkedin-touchcare-raw.json" /tmp/judge-li-tc.json
python3 /app/runtime/skills-user/medtrum-linkedin-spider/scripts/extract_for_judgment.py "$OD/linkedin-Medtrum-raw.json" /tmp/judge-li-md.json
```
...
```bash
OD="/app/.data/agent/background/medtrum-spider/linkedin"
python3 /app/runtime/skills-user/medtrum-linkedin-spider/scripts/merge_judgments.py "$OD/linkedin-touchcare-raw.json" /tmp/judge-li-tc-out.json "$OD/linkedin-touchcare.json"
python3 /app/runtime/skills-user/medtrum-linkedin-spider/scripts/merge_judgments.py "$OD/linkedin-Medtrum-raw.json" /tmp/judge-li-md-out.json "$OD/linkedin-Medtrum.json"

# 入库到共享 SQLite
python3 /app/.data/agent/background/medtrum-spider/shared/ingest.py "$OD/linkedin-touchcare.json" "$OD/linkedin-Medtrum.json"

# 验证入库数据一致性
python3 /app/.data/agent/background/medtrum-spider/shared/verify_ingest.py --fix "$OD/linkedin-touchcare.json" "$OD/linkedin-Medtrum.json"
```

## 输出
- `/app/.data/agent/background/medtrum-spider/linkedin/linkedin-touchcare.json`
- `/app/.data/agent/background/medtrum-spider/linkedin/linkedin-Medtrum.json`

## 验证命令
```bash
OD="/app/.data/agent/background/medtrum-spider/linkedin"
for kw in touchcare Medtrum; do
  json="$OD/linkedin-${kw}.json"
